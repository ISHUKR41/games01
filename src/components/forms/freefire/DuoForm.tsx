/**
 * Free Fire Duo Registration Form
 * File: src/components/forms/freefire/DuoForm.tsx
 * Purpose: Registration form for Free Fire Duo tournament
 * 
...
import { freefireDuoFormSchema, type FreefireDuoFormData } from '@/lib/validation/schemas'
...
/**
 * FreeFireDuoForm - Multi-step registration form for Free Fire Duo tournaments
 */
export const FreeFireDuoForm: React.FC = () => {
  const [currentStep, setCurrentStep] = useState(1)
  const [uploadedImageUrl, setUploadedImageUrl] = useState<string | null>(null)
  const { playSound } = useTypingSound()

  // Tournament details for Free Fire Duo
  const tournamentDetails = {
    ...
    killPrize: 5,
    capacity: 24,
    tournamentId: 'freefire-duo-tournament-id' // This would come from a tournament query
  }
  ...
  // Form setup
  const form = useForm<FreefireDuoFormData>({
    resolver: zodResolver(freefireDuoFormSchema),
    defaultValues: {
      team_name: '',
      leader_name: '',
      leader_game_id: '',
  ...
  const registerMutation = useMutation({
    mutationFn: async (data: FreefireDuoFormData) => {
  ...
  const onSubmit = (data: FreefireDuoFormData) => {
    if (isFull) {
        ...
        <CardContent className="p-4">
          ...
          <div className="mt-4 p-3 bg-background/50 rounded-lg">
            <div className="flex items-center justify-between mb-2">
              ...
              <span className={`text-sm font-bold ${isFull ? 'text-red-500' : slotsRemaining < 5 ? 'text-yellow-500' : 'text-green-500'}`}>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="space-y-2">
                        ...
                        <Input
                          id="player2_game_id"
                          placeholder="Enter player 2's Free Fire ID (must be different from leader)"
              ...
              {currentStep === 3 && (
                ...
                >
                  ...
                  <Card className="bg-muted/50">
                    <CardHeader>
                      <CardTitle className="text-lg">Team Registration Summary</CardTitle>
                    </CardHeader>
...
export default FreeFireDuoForm