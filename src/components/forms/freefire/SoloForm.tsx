/**
 * Free Fire Solo Registration Form
 * File: src/components/forms/freefire/SoloForm.tsx
 * Purpose: Registration form for Free Fire Solo tournament
 * 
...
import { freefireSoloFormSchema, type FreefireSoloFormData } from '@/lib/validation/schemas'
...
/**
 * FreeFireSoloForm - Multi-step registration form for Free Fire Solo tournaments
 */
export const FreeFireSoloForm: React.FC = () => {
  ...
  const tournamentDetails = {
    ...
    killPrize: 5,
    capacity: 48,
    tournamentId: 'freefire-solo-tournament-id' // This would come from a tournament query
  }
  ...
  const form = useForm<FreefireSoloFormData>({
    resolver: zodResolver(freefireSoloFormSchema),
    defaultValues: {
      leader_name: '',
      leader_game_id: '',
      leader_whatsapp: '',
  ...
  const onSubmit = (data: FreefireSoloFormData) => {
    if (isFull) {
        ...
        <CardContent className="p-4">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-sm text-muted-foreground">Individual competition • {tournamentDetails.capacity} players • 10-min matches</p>
            </div>
