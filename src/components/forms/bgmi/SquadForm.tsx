/**
 * BGMI Squad Registration Form
 * File: src/components/forms/bgmi/SquadForm.tsx
 * Purpose: Registration form for BGMI Squad tournament
 * 
...
import { bgmiSquadFormSchema, type BgmiSquadFormData } from '@/lib/validation/schemas'
...
/**
 * BGMISquadForm - Multi-step registration form for BGMI Squad tournaments
 */
export const BGMISquadForm: React.FC = () => {
  const [currentStep, setCurrentStep] = useState(1)
  const [uploadedImageUrl, setUploadedImageUrl] = useState<string | null>(null)
  const { playSound } = useTypingSound()

  // Tournament details for BGMI Squad
  const tournamentDetails = {
    ...
    killPrize: 9,
    capacity: 25,
    tournamentId: '10000000-0000-4000-8000-000000000003'
  }
  ...
  const form = useForm<BgmiSquadFormData>({
    resolver: zodResolver(bgmiSquadFormSchema),
    defaultValues: {
      team_name: '',
      leader_name: '',
      leader_game_id: '',
  ...
  const registerMutation = useMutation({
    mutationFn: async (data: BgmiSquadFormData) => {
  ...
  const onSubmit = (data: BgmiSquadFormData) => {
    if (isFull) {
      ...
      <Card className="bg-gradient-to-r from-orange-500/10 to-red-500/10 border-orange-500/20">
        <CardContent className="p-4">
          <div className="flex items-center justify-between">
            <div>
              <h3 className="font-semibold text-lg">BGMI Squad Tournament</h3>
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="space-y-2">
                        <Label htmlFor="player3_game_id" className="flex items-center gap-2">
                          <Gamepad2 className="h-4 w-4" />
                          Player 3 BGMI Game ID
                        </Label>
                        <Input
                          id="player3_game_id"
                          placeholder="Enter player 3's BGMI ID"
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="space-y-2">
                        <Label htmlFor="player4_game_id" className="flex items-center gap-2">
                          <Gamepad2 className="h-4 w-4" />
                          Player 4 BGMI Game ID
                        </Label>
                        <Input
                          id="player4_game_id"
                          placeholder="Enter player 4's BGMI ID (all Game IDs must be unique)"
