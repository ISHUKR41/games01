/**
 * BGMI Duo Registration Form
 * File: src/components/forms/bgmi/DuoForm.tsx
 * Purpose: Registration form for BGMI Duo tournament
 * 
 * This form handles duo team registration with validation,
...
import { bgmiDuoFormSchema, type BgmiDuoFormData } from '@/lib/validation/schemas'
...
/**
 * BGMIDuoForm - Multi-step registration form for BGMI Duo tournaments
 */
export const BGMIDuoForm: React.FC = () => {
  const [currentStep, setCurrentStep] = useState(1)
  const [uploadedImageUrl, setUploadedImageUrl] = useState<string | null>(null)
  const { playSound } = useTypingSound()

  // Tournament details for BGMI Duo
  const tournamentDetails = {
    ...
    killPrize: 9,
    capacity: 50,
    tournamentId: 'bgmi-duo-tournament-id' // This would come from a tournament query
  }
  ...
  // Form setup
  const form = useForm<BgmiDuoFormData>({
    resolver: zodResolver(bgmiDuoFormSchema),
    defaultValues: {
      team_name: '',
      leader_name: '',
      leader_game_id: '',
  ...
  const registerMutation = useMutation({
    mutationFn: async (data: BgmiDuoFormData) => {
  ...
  const onSubmit = (data: BgmiDuoFormData) => {
    if (isFull) {
      ...
      <Card className="bg-gradient-to-r from-orange-500/10 to-red-500/10 border-orange-500/20">
        <CardContent className="p-4">
          <div className="flex items-center justify-between">
            <div>
              <h3 className="font-semibold text-lg">BGMI Duo Tournament</h3>
              <p className="text-sm text-muted-foreground">Team competition • {tournamentDetails.capacity} teams • 2 players per team</p>
            </div>
          ...
          <div className="mt-4 p-3 bg-background/50 rounded-lg">
            <div className="flex items-center justify-between mb-2">
              ...
              <span className={`text-sm font-bold ${isFull ? 'text-red-500' : slotsRemaining < 10 ? 'text-yellow-500' : 'text-green-500'}`}>
              ...
              {currentStep === 1 && (
                ...
                >
                  <div className="space-y-4">
                    ...
                    <div className="space-y-4">
                      <h4 className="font-semibold text-primary">Team Leader</h4>
                      ...
                      <div className="space-y-2">
                        ...
                        <Input
                          id="leader_game_id"
                          placeholder="Enter leader's BGMI ID"
                    ...
                    <div className="space-y-4">
                      <h4 className="font-semibold text-secondary">Player 2</h4>
                      
                      <div className="space-y-2">
                        <Label htmlFor="player2_name" className="flex items-center gap-2">
                          <User className="h-4 w-4" />
                          Player 2 Name
                        </Label>
                        <Input
                      ...
                      <div className="space-y-2">
                        <Label htmlFor="player2_game_id" className="flex items-center gap-2">
                          <Gamepad2 className="h-4 w-4" />
                          Player 2 BGMI Game ID
                        </Label>
                        <Input
                          id="player2_game_id"
                          placeholder="Enter player 2's BGMI ID"
                  ...
                  <Card className="bg-muted/50">
                    ...
                    <CardContent className="space-y-4">
                      <div className="grid gap-3">
                        ...
                        <Separator />
                        <div className="space-y-2">
                          <h5 className="font-medium text-primary">Team Leader</h5>
                        ...
                        <div className="space-y-2">
                          ...
                          <div className="flex justify-between text-sm">
                            <span className="text-muted-foreground">Name:</span>
                            <span>{watchedFields.player2_name}</span>
                          </div>
                          <div className="flex justify-between text-sm">
                            <span className="text-muted-foreground">Game ID:</span>
                            <span>{watchedFields.player2_game_id}</span>
                          </div>
                        </div>
                        <Separator />
                        <div className="flex justify-between">
              ...
              {currentStep === 4 && (
                ...
                >
                  <div className="space-y-4">
                    ...
                    <div className="space-y-2">
                      <h3 className="text-2xl font-bold text-green-600">Team Registration Successful!</h3>
                      <p className="text-muted-foreground">
                        Your team registration has been submitted and is pending admin approval.
                      </p>
                    </div>
                    ...
                    <Card className="bg-green-500/10 border-green-500/20">
                      <CardContent className="p-4 text-sm space-y-2">
                        ...
                        <ul className="text-left space-y-1 text-muted-foreground">
                          ...
                          <li>• Team leader will receive WhatsApp notification once approved</li>
